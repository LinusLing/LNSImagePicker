...
class VideoPickerPreviewCell:UICollectionViewCell{
    ...
    weak var controller:LNSImagePickerPreviewController?
    var model:LNSImagePickerModel!
    ...
    func initWithModel(model:LNSImagePickerModel,controller:LNSImagePickerPreviewController) {
    ...
    func didEndScroll() {
        ...
        if let playerItem = self.model.getAVPlayerItem() {
            ...
            if let currentItem = self.avPlayer.currentItem {
                self.avPlayer.addBoundaryTimeObserver(forTimes: [NSValue.init(time: currentItem.asset.duration)], queue: nil) {
                    [unowned self] in
